...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
  this._oauth.get('https://api.linkedin.com/v1/people/~:(id,first-name,last-name,location,industry,interests,positions,languages,skills,certifications,educations,courses,volunteer,date-of-birth,picture-url,public-profile-url)?format=json', token, tokenSecret, function (err, body, res) {
